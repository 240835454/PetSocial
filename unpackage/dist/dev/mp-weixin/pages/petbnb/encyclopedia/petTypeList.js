...
var _petTypeList = _interopRequireDefault(__webpack_require__(/*! ./pages/petbnb/encyclopedia/petTypeList.vue */ 71));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _petTypeList_vue_vue_type_template_id_76624d6e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./petTypeList.vue?vue&type=template&id=76624d6e& */ 72);
/* harmony import */ var _petTypeList_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./petTypeList.vue?vue&type=script&lang=js& */ 74);
...
/* harmony import */ var _petTypeList_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./petTypeList.vue?vue&type=style&index=0&lang=less& */ 77);
...
var _formatList = __webpack_require__(/*! ../../../util/js/formatList.js */ 76); //
//
//
//
//
...
//
//
var TITLE_HEIGHT = 23;var _default = { data: function data() {return { title: 'Hello', list: [], fixedTop: '', listHeight: [], height: 1000, currentIndex: 0, fixedTitle: '', scrollTop: 0, toNum: 0, name: '', id: '' };}, onLoad: function onLoad(options) {this.id = options.id;this.name = options.name;uni.setNavigationBarTitle({ title: this.name });this.getList();}, mounted: function mounted() {this._calculateHeight();
  },
  methods: {
